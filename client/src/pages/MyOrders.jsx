      ...
      <div className="px-4 md:px-16 lg:px-24 xl:px-32">
        <div className="max-w-2xl mx-auto mt-14 bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className='text-sm text-gray-500 mt-2'>
            You havent purchased any listings yet
          </p>
        </div>
          ...
          return (
            <div key={id} className='bg-white rounded-lg border border-gray-200 p-5 flex flex-col max-w-4xl'>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div >
                      ...
                      <p className='text-sm text-gray-500 mt-1'>
                        @{listing.username} | <span className='capitalize'>{listing.plaform}</span>
                      </p>
              ...
              <div className='flex flex-col gap-2 items-end'>
                <button onClick={()=>setExpandedId((p)=>(p===id?null:id))} className='flex items-center gap-2 bg-white border border-gray-200 px-3 py-2 rounded hover:shadow text-sm '>
                  {isExpanded ? (
                    <>
