...
import { ArrowLeftIcon, ArrowUpRightFromSquareIcon, Calendar, CheckCircle2, ChevronLeftIcon, ChevronRightIcon, DollarSign, EyeIcon, LineChart, Loader2Icon, MapPin, MessageSquare, MessageSquareMoreIcon, ShoppingBagIcon, Users } from 'lucide-react'
      ...
      <div className='flex items-start max-md:flex-col gap-10'>
        <div className='flex-1 max-md:w-full'>
          ...
          {images?.length>0&&(
            ...
            <div className='bg-white rounded-xl border-gray-200 mb-5'>
