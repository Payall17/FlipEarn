import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Edit, Eye, EyeOffIcon, LockIcon, Plus, PlusIcon, StarIcon, TrashIcon, TrendingUp, Users, WalletIcon, XCircle } from 'lucide-react'
          ...
          <div key={listing.id} className='bg-white rounded-lg border border-gray-200 hover:shadow-lg shadow-gray-200/70 transition-shadow'>
            <div className='p-6'>
              <div className="flex items-start gap-4 justify-between mb-4 ">
                {platformIcons[listing.platform]}<div className='flex-1'>
                          ...
                          <div className='bg-white text-gray-600 text-xs rounded border border-gray-200 p-2 px-3'>
                            ...
                            <button className='text-nowrap'>
                                ...
                                <span className={
                                  ...
                                  {listing.isCredentialSubmitted? listing.isCredentialVerified ? listing.isCredentialChanged ? "Changed":"Verfied": "Submitted" : "Not submitted"}
                                </span>
                            </button>
                          </div>
                        </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between pt-3 border-t border-gray-200'>
                  ...
                  <div className='flex items-center space-x-2'>
                    {listing.status !== "sold" && (
                      <button onClick={()=>deleteListing(listing.id)} className='p-2 border border-gray-300 ounded-lg hover:bg-gray-50 hover:text-red-500'>
    ...
    {/* Footer   */}
      <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
            <p className='text-sm text-gray-500'>
              2026 <span className='text-indigo-600'>Surayal</span>. All rights reserved. 
            </p>
      </div>
    </div>
  )
