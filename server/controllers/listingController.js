...
//Controller to get all Public Listings
...
//Controller to get all user listing
...
//controller to update listings in db
...
export const toggleStatus= async(req, res)=>{
    try {
        ...
        if(listing.status ==="active"||listing.status==="inactive"){
            ...
            return res.status(400).json({message:"Your lisitng is banned"})
        }else if(listing.status==="sold"){
            return res.status(400).json({message:"Your lisitng is sold"})
        }
...
export const deleteUserListing= async(req, res)=>{
    try {
        ...
        if(listing.status==="sold"){
            return res.status(400).json({message:"Sold listing cant be deleted"})
        }
